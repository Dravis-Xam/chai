    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-start border-b border-gray-200 dark:border-gray-800 px-6 py-4">
          ...
          {/* Quick Actions - Evenly Spaced Buttons */}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {cartItems.length === 0 ? (
            <div className="flex h-full flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Your cart is empty</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-500">Add some delicious chai to get started!</p>
            </div>
          ) : (
